import { responsiveWebData } from "../../../data/web";
import { Link } from "react-router-dom";
import { FaMobileAlt } from "react-icons/fa";

const ResponsiveWeb = () => {
  const { hero, sections, cta } = responsiveWebData;
  ...
  return (
    <section className="bg-white text-black dark:bg-black dark:text-white overflow-hidden">
      ...
      <div
        ...
        from-emerald-500/20 via-white to-teal-200/20
        dark:from-emerald-500/20 dark:via-black dark:to-teal-600/20"
      >
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            {sections.process.steps.map((step, i) => (
              <div
                ...
                hover:border-emerald-500"
              >
                <div className="text-emerald-500 text-2xl font-bold mb-3">
                  0{i + 1}
                </div>
                <p className="text-gray-700 dark:text-gray-300">
                  {step}
      ...
      <div className="py-24 px-6">
        <div
          ...
          from-emerald-500 to-teal-500 p-14 rounded-xl
