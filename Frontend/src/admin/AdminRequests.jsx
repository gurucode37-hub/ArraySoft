          ...
          <table className="w-full border border-gray-300 dark:border-white/10 rounded-lg">
            <thead className="bg-gray-100 dark:bg-[#111]">
              <tr className="text-orange-500 dark:text-orange-400 text-left">
                <th className="p-3 border-b border-gray-300 dark:border-white/10">
                  #
                </th>
                <th className="p-3 border-b border-gray-300 dark:border-white/10">
                  Name
            ...
            <tbody>
              {requests.map((req, index) => (
                ...
                >
                  <td className="p-3 border-b border-gray-300 dark:border-white/10">
                    {index + 1}
                  </td>
                  <td className="p-3 border-b border-gray-300 dark:border-white/10">
                    {req.username}
                  ...
                  <td className="p-3 border-b border-gray-300 dark:border-white/10 max-w-md">
                    {req.message}
                  </td>
                </tr>
              ))}
